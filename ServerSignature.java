...
class ServerSignature {
	...
	// ServerSignature constructor
	protected ServerSignature() throws Exception {}

	protected void initializeServerSignature() 
	throws Exception {
	...
	protected boolean verifyMessage(String clientMessage)
	throws Exception {
